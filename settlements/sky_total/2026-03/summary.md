...
| Sent to Core Council | of which: Step 1 Capital (20% × SNR, add-back) | +-1,488,961.84 |
| Sent to Core Council | of which: **genesis repayment (net cost)** | **-4,034,868.84** |
| Grove TGE penalty (excluded from Sky revenue) | unset | -0.00 |
| **MSC net (buffer basis)** | | **131,781.61** |
