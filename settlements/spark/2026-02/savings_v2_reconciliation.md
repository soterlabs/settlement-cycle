...
- `pol_agent_rate` (S32 only, +20bps over SSR): $90,940.64
- `susds_pol_ssr_credit` (every sky_savings_token Cat B venue: S32 + L2 proxies, SSR rate): $2,908,839.44
- **Combined sUSDS POL sky_revenue reduction: $2,999,780.07**
