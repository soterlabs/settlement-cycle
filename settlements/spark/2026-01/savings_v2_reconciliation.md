...
- `pol_agent_rate` (S32 only, +20bps over SSR): $87,501.45
- `susds_pol_ssr_credit` (every sky_savings_token Cat B venue: S32 + L2 proxies, SSR rate): $2,387,351.61
- **Combined sUSDS POL sky_revenue reduction: $2,474,853.06**
