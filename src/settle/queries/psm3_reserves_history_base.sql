-- PSM3 pool reserves per token per event-block (cumulative) on Base.
--
-- See the sibling files for Arbitrum / Optimism / Unichain — same body, only
...
--
-- We use the chain-scoped ``erc20_base.evt_transfer`` spell rather than
