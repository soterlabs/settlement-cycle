-- PSM3 pool reserves per token per event-block (cumulative) on Optimism.
--
-- See the sibling files for Arbitrum / Base / Unichain — same body, only
...
--
-- We use the chain-scoped ``erc20_optimism.evt_transfer`` spell rather than
