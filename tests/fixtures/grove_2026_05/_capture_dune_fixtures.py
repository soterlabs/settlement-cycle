"""Capture Grove May-2026 Dune fixture set.

Same query inventory as the April capture, pinned to May 31 EoM blocks.
SoM = April EoM (one-block-back is fine; the cum_balance series spans
...
OUT = _REPO / "tests" / "fixtures" / "grove_2026_05"
OUT.mkdir(parents=True, exist_ok=True)

# May 2026 pin blocks — May 31 23:59:59 UTC EoD blocks per chain.
# Captured via blocks_at_eod query on 2026-06-02.
PIN_BLOCKS_SOM = {
...
def main() -> int:
    ...
    print(f"May 2026 fixture capture (Eth EoM = {eth_eom})")
    fx = {
        "_about": f"Grove May 2026 fixture, captured via Dune on 2026-06-02; "
    ...
    with open(_REPO / "tests/fixtures/grove_2026_04/dune_outputs.json") as f:
        prev = json.load(f)
    ...
    for chain in ("ethereum", "base", "avalanche_c", "plume", "monad"):
        ...
        df = execute_query(
            ...
            params={"chain": chain, "start_date": START_DATE, "end_date": "2026-05-31"},
            pin_block=pb,
        )
