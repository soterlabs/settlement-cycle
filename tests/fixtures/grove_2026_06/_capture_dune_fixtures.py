...
OUT = _REPO / "tests" / "fixtures" / "grove_2026_06"
OUT.mkdir(parents=True, exist_ok=True)

# June 2026 (FULL MONTH) pin blocks. SoM = May 31 EoM. EoM = June 30
# 23:59:59 UTC EoD blocks per chain. Resolved via blocks_at_eod query on
# 2026-07-03 (eth/base/avax cross-checked against the Spark fixture refresh).
PIN_BLOCKS_SOM = {
...
def main() -> int:
    ...
    print(f"June 2026 (full month) fixture capture (Eth EoM = {eth_eom})")
    fx = {
        "_about": f"Grove June 2026 (full month) fixture, re-captured via Dune on 2026-07-03; "
    ...
    print("\nJune (full month) fixture data captured.")
    return 0
