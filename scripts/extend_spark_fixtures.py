...
SAFETY_PIN_BLOCK = {
    ...
    # avax 94159927 — resolved via HyperSync binary search 2026-09-01;
    # re-deriving the July-31 pins the same way reproduced the published
    # July values on every chain).
    "ethereum":    25880000,
    "base":        50730000,
    "arbitrum":   500500000,
    "optimism":   156330000,
