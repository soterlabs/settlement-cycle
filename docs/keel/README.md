...
Keel is a prime agent in the Sky ecosystem.
...
All queries are shared parameterized templates in [`queries/`](../../queries/) (in this repo). Fill in Keel-specific parameters:
